    ...
    public ResponsePartDTO sendDataPayment(PaymentDTO paymentDTO) {
        ...
        try {
            ...
            AMQP.BasicProperties props = new AMQP.BasicProperties
                    ...
                    .build();
            log.info("---------------");
            channel.basicPublish(ConfigRabbitMq.getConfigRabbitMq().getDIRECT_EXCHANGE_PAYMENT(), ConfigRabbitMq.getConfigRabbitMq().getKEY_PAYMENT(), props,
            ...
            log.error("Create RPC RabbitMQ failed! " + e.getMessage());
        } finally {
        if (channel != null)
